...
const en = {
  ...
  "home.installBanner.title": "Get the Android app!",
  "home.installBanner.description": "Install Happy Kids Academy from Google Play for a faster, offline-ready experience.",
  "home.installBanner.cta": "Install Now",
  "home.installBanner.dismiss": "Dismiss",
  ...
  "learn.moreAbout": "More about {label}",
...
const gu: Record<TranslationKey, string> = {
  ...
  "home.installBanner.title": "એન્ડ્રોઇડ એપ મેળવો!",
  "home.installBanner.description": "ઝડપી, ઓફલાઇન અનુભવ માટે Google Play પરથી Happy Kids Academy ઇન્સ્ટોલ કરો.",
  "home.installBanner.cta": "હમણાં ઇન્સ્ટોલ કરો",
  "home.installBanner.dismiss": "બંધ કરો",
  ...
  "learn.moreAbout": "{label} વિશે વધુ",
...
const hi: Record<TranslationKey, string> = {
  ...
  "home.installBanner.title": "एंड्रॉइड ऐप पाएं!",
  "home.installBanner.description": "तेज़, ऑफ़लाइन अनुभव के लिए Google Play से Happy Kids Academy इंस्टॉल करें।",
  "home.installBanner.cta": "अभी इंस्टॉल करें",
  "home.installBanner.dismiss": "बंद करें",
  ...
  "learn.moreAbout": "{label} के बारे में और जानें",
